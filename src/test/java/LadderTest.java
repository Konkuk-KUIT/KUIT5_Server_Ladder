...
class LadderTest {
    ...
    void PrintLadder() {
        //given
        Ladder ladder = new Ladder(GreaterThanZero.from(3), GreaterThanZero.from(3));
    ...
    void OnePeople() {
        //given
        Ladder ladder = new Ladder(GreaterThanZero.from(2), GreaterThanZero.from(1));
        LadderRunner ladderRunner = new LadderRunner(ladder);
        //when
        int selectedPerson = ladderRunner.run(1);
    ...
    void moreThanTwoPeopleEven2() {
        //given
        Ladder ladder = new Ladder(GreaterThanZero.from(3), GreaterThanZero.from(4));
        ladder.drawLine(0, 0, 0, 1);
        ladder.drawLine(1, 1, 1, 2);
